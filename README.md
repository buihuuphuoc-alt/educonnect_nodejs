...
├── scripts/
│   └── migrate-passwords.js    # Script hỗ trợ migration
...
Sau khi chạy `node src/create-admin.js`:
...
- **Mật khẩu**: hệ thống lưu mật khẩu dạng plain text, phù hợp cho môi trường phát triển/demo.