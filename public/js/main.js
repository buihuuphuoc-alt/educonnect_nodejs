      ...
      try {
        ...
        if (data.success) {
          if (data.must_change_password) {
            // Hiện cảnh báo đổi mật khẩu, không redirect tự động
            const msgEl = document.getElementById('login-msg');
            if (msgEl) {
              msgEl.innerHTML = '⚠️ ' + data.message + ' <a href="/doi-mat-khau" style="color:#b45309;font-weight:700;text-decoration:underline;">Đổi mật khẩu ngay →</a>';
            ...
            setTimeout(() => {
              location.href = data.redirect_url || data.redirect || '/';
            }, 800);
          }
        } else {
